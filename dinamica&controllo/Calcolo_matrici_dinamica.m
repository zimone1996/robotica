...
B1_m=(M_r1*(JP_m1)'*JP_m1+(JO_m1)'*I_m1*JO_m1);
B1=B1_l+B1_m;

%% Link e motore 2
B2_l=simplify(M_2*(JP_l2)'*JP_l2+(JO_l2)'*I_02*JO_l2);
B2_m=simplify(M_r2*(JP_m2)'*JP_m2+(JO_m2)'*I_m2*JO_m2);
B2=B2_l+B2_m;

%% Link e motore 3
B3_l=simplify(M_3*(JP_l3)'*JP_l3+(JO_l3)'*I_03*JO_l3);
B3_m=simplify(M_r3*(JP_m3)'*JP_m3+(JO_m3)'*I_m3*JO_m3);
B3=B3_l+B3_m;

%% Link e motore 4
B4_l=simplify(M_4*(JP_l4)'*JP_l4+(JO_l4)'*I_04*JO_l4);
B4_m=simplify(M_r4*(JP_m4)'*JP_m4+(JO_m4)'*I_m4*JO_m4);
B4=B4_l+B4_m;
...
for i=1:4
   g_m(i)=simplify(M_r1*g0'*JP_m1(:,i)+M_r2*g0'*JP_m2(:,i)+ ...
          M_r3*g0'*JP_m3(:,i));
